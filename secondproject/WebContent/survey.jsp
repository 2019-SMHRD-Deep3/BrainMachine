...
<body>
<h1><strong>BIG 5 테스트</strong></h1>
<h3>총50문항으로 순서대로 답변을 해주시면 됩니다.<br>
질문을 읽은 후 너무 많은 생각을 하기보다는 바로 선택하세요.
</h3>
   <h2>1. 나는 모임을 즐기는 타입이다.</h2>
   <div id="out">
     <span class="disagree" >전혀 일치하지 않는다</span>
      <div id="in">
...
<button onclick="location='survey2.jsp'" id="btn1">다음페이지</button>
</body>
</html>