...
<body>
	...
	<h2 id = "1">11. 나는 쉽게 스트레스를  받는 편이다.</h2>
	<div class="ttt1">
		<div class="out">
	...
	<h2 id = "2">12. 나는 정서적으로 안정되어 있다.</h2>
	<div class="ttt2">
		<div class="out">
			<span class="textagree">전혀 일치하지 않는다</span>
		</div>
	...
	<h2 id = "4">14. 나는 우울함을 자주 느끼는 편이 아니다.</h2>
	<div class="ttt4">
		<div class="out">
			<span class="textagree">전혀 일치하지 않는다</span>
		</div>
	...
	<h2 id = "8">18. 나는 종종 기분 변화가 심해질 때가 있다.</h2>
	<div class="ttt8">
		<div class="out">
			<span class="textagree">전혀 일치하지 않는다</span>
		</div>
	...
	<script type="text/javascript">
		...
		$('.btn1').on('click',function(){
			...
			var radio11 = Number($('input:radio[name="radio1"]:checked').val());
			var radio12 = Number($('input:radio[name="radio2"]:checked').val());
			var radio13 = Number($('input:radio[name="radio3"]:checked').val());
			var radio14 = Number($('input:radio[name="radio4"]:checked').val());
			var radio15 = Number($('input:radio[name="radio5"]:checked').val());
			var radio16 = Number($('input:radio[name="radio6"]:checked').val());
			var radio17 = Number($('input:radio[name="radio7"]:checked').val());
			var radio18 = Number($('input:radio[name="radio8"]:checked').val());
			var radio19 = Number($('input:radio[name="radio9"]:checked').val());
			var radio20 = Number($('input:radio[name="radio10"]:checked').val());
			
			var array = [radio11,radio12,radio13,radio14,radio15,radio16,radio17,radio18,radio19,radio20];
			var EST = radio11+radio12+radio13+radio14+radio15+radio16+radio17+radio18+radio19+radio20;
			sessionStorage.setItem("radio11", radio11);
			sessionStorage.setItem("radio12", radio12);
			sessionStorage.setItem("radio13", radio13);
			sessionStorage.setItem("radio14", radio14);
			sessionStorage.setItem("radio15", radio15);
			sessionStorage.setItem("radio16", radio16);
			sessionStorage.setItem("radio17", radio17);
			sessionStorage.setItem("radio18", radio18);
			sessionStorage.setItem("radio19", radio19);
			sessionStorage.setItem("radio20", radio20);
			...
			var offset = 's';
	         ...
	         for (var i = 0;i<array.length; i++){
	            ...
	            if (i == array.length-1){
	             ...
	             $(location).attr('href','survey3.jsp'); 
	            }
	         }
