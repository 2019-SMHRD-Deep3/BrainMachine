...
<body>
  ...
  <div class="ttt">
   ...
   <h2>36. 나는 원래 두웠던 위치를 자주 잊어버린다.</h2>
   <div class="ttt">
      <div class="out">
         <span class="textagree">비동의</span>
      </div>
 ...
 <div id="btn_group">
<button onclick="location='survey3.jsp'" id="btn1">이전페이지</button>
<button id="btn2">다음페이지</button>
