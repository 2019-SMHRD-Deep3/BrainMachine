...
<body>
   ...
   <h2>36. 나는 원래 두었던 위치를 자주 잊어버린다.</h2>
   <div id="out">
      <div id="in">
...
<button onclick="location='survey3.jsp'">이전페이지</button>
<button onclick="location='survey5.jsp'">다음페이지</button>
</body>
</html>